  ...
  return (
    <div className="carousel w-full lg:h-[680px]">
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <img src={img2} className="h-full w-full rounded-lg" />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
      ...
      <div id="slide3" className="carousel-item relative w-full">
        <img src={img3} className="h-full w-full rounded-lg" />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-3 lg:space-y-7 pl-7 lg:pl-20 lg:w-1/2">
            <h2 className="text-2xl lg:text-5xl font-bold">
              Affordable Price For Car Servicing
      ...
      <div id="slide4" className="carousel-item relative w-full">
        <img src={img4} className="h-full w-full rounded-lg" />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-3 lg:space-y-7 pl-7 lg:pl-20 lg:w-1/2">
            <h2 className="text-2xl lg:text-5xl font-bold">
              Affordable Price For Car Servicing
      ...
      <div id="slide5" className="carousel-item relative w-full">
        <img src={img5} className="h-full w-full rounded-lg" />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-3 lg:space-y-7 pl-7 lg:pl-20 lg:w-1/2">
            <h2 className="text-2xl lg:text-5xl font-bold">
              Affordable Price For Car Servicing
      ...
      <div id="slide6" className="carousel-item relative w-full">
        <img src={img6} className="h-full w-full rounded-lg" />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-3 lg:space-y-7 pl-7 lg:pl-20 lg:w-1/2">
            <h2 className="text-2xl lg:text-5xl font-bold">
              Affordable Price For Car Servicing
